...
diabetes_model = pickle.load(open('G:\College\Disease Predictor\Models\diabetes_model.sav', 'rb'))

heart_disease_model = pickle.load(open('G:\College\Disease Predictor\Models\heart_disease_model.sav', 'rb'))
